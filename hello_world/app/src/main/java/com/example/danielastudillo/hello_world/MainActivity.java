package com.example.danielastudillo.hello_world;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((TextView) findViewById(R.id.textView)).setTextColor(getResources().getColor(R.color.yellowGreen));
            }
        });
        ...
        findViewById(R.id.button3).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(updatedText)){
                    ((TextView) findViewById(R.id.textView)).setText("Hello from Daniel!");
                }
                else {
